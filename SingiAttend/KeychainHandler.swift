...
//  SingiAttend
//
//  Created by Марко Дојкић on 2.7.23..
//  Copyright © 2023 Марко Дојкић. All rights reserved.
//
...
struct KeychainPasswordItem {
    ...
    init(service: String? = (Bundle.main.infoDictionary!["KeyChainServiceName"]! as? String), account: String, accessGroup: String? = nil) {
